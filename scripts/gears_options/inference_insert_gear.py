...
class GearInsertPolicy(object):
    ...
    def __init__(self, pr2_left=None, pr2_right=None):
        ...
        # self.pr2_right.add_collision_safety_box()
    ...
    def prepare(self):
        # self.pr2_right.move_to_p_rpy([0.400, -0.562, 0.910], [-1.765, 0.082, 1.170])
        ...
        # self.delta_pose = [0.1, 0.49, 0.08]
        # self.delta_pose = [0.1, 0.50, 0.08]
    ...
    def act(self):
        ...
        # cv2.waitKey(100)
        #TODO: get last image. do IK jointTrajectory and exec
        ...
        # self.pr2_left.service_left_fk([1.4624555509424477, 0.11920850591350829, 0.29666000058844694, -6.09845021611952, -0.826758739549585, -0.8585302780489211, 6.44454170991527])
        # self.pr2_left.service_left_fk(output_j)
